                                    ...
                                    <div class="row">
                                        <div class="col-md-7 col-sm-12">
                                            <div class="new-cars-img">
                                                <img src="public/assets/images/new-cars-model/ncm1.png" alt="img" />
                                            </div>
                                        </div>
                            ...
                            <div class="new-cars-item">
                                <div class="single-new-cars-item">
                                    <div class="row">
                                        <div class="col-md-7 col-sm-12">
                                            <div class="new-cars-img">
                                                <img src="public/assets/images/new-cars-model/ncm2.png" alt="img" />
                                            </div>
                                            {/* <!--/.new-cars-img--> */}
                                        </div>
                                        <div class="col-md-5 col-sm-12">
                            ...
                            <div class="new-cars-item">
                                <div class="single-new-cars-item">
                                    <div class="row">
                                        <div class="col-md-7 col-sm-12">
                                            <div class="new-cars-img">
                                                <img src="public/assets/images/new-cars-model/ncm3.png" alt="img" />
                                            </div>
                                            {/* <!--/.new-cars-img--> */}
                                        </div>
                                        <div class="col-md-5 col-sm-12">
